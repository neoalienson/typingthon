...
abstract class HistoryRecordCollectionReference
    implements
        HistoryRecordQuery,
        FirestoreCollectionReference<HistoryRecord,
            HistoryRecordQuerySnapshot> {
...
abstract class HistoryRecordDocumentReference
    extends FirestoreDocumentReference<HistoryRecord,
        HistoryRecordDocumentSnapshot> {
...
class _$HistoryRecordDocumentReference extends FirestoreDocumentReference<
    HistoryRecord,
    HistoryRecordDocumentSnapshot> implements HistoryRecordDocumentReference {
  ...
  @override
  Stream<HistoryRecordDocumentSnapshot> snapshots() {
    return reference.snapshots().map(HistoryRecordDocumentSnapshot._);
  }

  @override
  Future<HistoryRecordDocumentSnapshot> get([GetOptions? options]) {
    return reference.get(options).then(HistoryRecordDocumentSnapshot._);
  }

  @override
  Future<HistoryRecordDocumentSnapshot> transactionGet(
      Transaction transaction) {
    return transaction.get(reference).then(HistoryRecordDocumentSnapshot._);
  }
  ...
  Future<void> update({
    ...
    assert(
      wpm == _sentinel || wpmFieldValue == null,
      "Cannot specify both wpm and wpmFieldValue",
    );
    final json = {
      if (datetime != _sentinel)
        _$HistoryRecordFieldMap['datetime']!: datetime as DateTime,
      if (datetimeFieldValue != null)
        _$HistoryRecordFieldMap['datetime']!: datetimeFieldValue,
      if (wpm != _sentinel) _$HistoryRecordFieldMap['wpm']!: wpm as int,
      if (wpmFieldValue != null) _$HistoryRecordFieldMap['wpm']!: wpmFieldValue,
    };
...
abstract class HistoryRecordQuery
    implements QueryReference<HistoryRecord, HistoryRecordQuerySnapshot> {
  @override
  ...
  /// collection.orderByTitle(startAt: 'title');
  /// ```
  HistoryRecordQuery orderByFieldPath(
    FieldPath fieldPath, {
    bool descending = false,
    Object? startAt,
    Object? startAfter,
  ...
  /// collection.whereTitle(isEqualTo: 'title');
  /// ```
  HistoryRecordQuery whereFieldPath(
    FieldPath fieldPath, {
    Object? isEqualTo,
    Object? isNotEqualTo,
    Object? isLessThan,
  ...
  HistoryRecordQuery whereDocumentId({
    String? isEqualTo,
    String? isNotEqualTo,
    String? isLessThan,
    String? isLessThanOrEqualTo,
  ...
  HistoryRecordQuery whereDatetime({
    DateTime? isEqualTo,
  ...
  HistoryRecordQuery orderByDocumentId({
    bool descending = false,
    String startAt,
    String startAfter,
    String endAt,
  ...
  HistoryRecordQuery orderByDatetime({
    bool descending = false,
    DateTime startAt,
    DateTime startAfter,
    DateTime endAt,
...
class _$HistoryRecordQuery
    extends QueryReference<HistoryRecord, HistoryRecordQuerySnapshot>
    implements HistoryRecordQuery {
  _$HistoryRecordQuery(
    this._collection, {
    required Query<HistoryRecord> $referenceWithoutCursor,
    $QueryCursor $queryCursor = const $QueryCursor(),
  }) : super(
          $referenceWithoutCursor: $referenceWithoutCursor,
          $queryCursor: $queryCursor,
  ...
  Stream<HistoryRecordQuerySnapshot> snapshots([SnapshotOptions? options]) {
    return reference
        .snapshots()
        .map(HistoryRecordQuerySnapshot._fromQuerySnapshot);
  }
  ...
  Future<HistoryRecordQuerySnapshot> get([GetOptions? options]) {
    return reference
        .get(options)
        .then(HistoryRecordQuerySnapshot._fromQuerySnapshot);
  }
  ...
  HistoryRecordQuery whereDatetime({
    ...
    return _$HistoryRecordQuery(
      _collection,
      $referenceWithoutCursor: $referenceWithoutCursor.where(
        _$HistoryRecordFieldMap['datetime']!,
        isEqualTo: isEqualTo,
        isNotEqualTo: isNotEqualTo,
        isLessThan: isLessThan,
        isLessThanOrEqualTo: isLessThanOrEqualTo,
  ...
  HistoryRecordQuery orderByDatetime({
    ...
    final query = $referenceWithoutCursor
        .orderBy(_$HistoryRecordFieldMap['datetime']!, descending: descending);
    var queryCursor = $queryCursor;
  ...
  HistoryRecordQuery orderByWpm({
    ...
    final query = $referenceWithoutCursor
        .orderBy(_$HistoryRecordFieldMap['wpm']!, descending: descending);
    var queryCursor = $queryCursor;
...
class HistoryRecordDocumentSnapshot
    extends FirestoreDocumentSnapshot<HistoryRecord> {
  HistoryRecordDocumentSnapshot._(this.snapshot) : data = snapshot.data();
...
class HistoryRecordQuerySnapshot extends FirestoreQuerySnapshot<HistoryRecord,
    HistoryRecordQueryDocumentSnapshot> {
  ...
  factory HistoryRecordQuerySnapshot._fromQuerySnapshot(
    QuerySnapshot<HistoryRecord> snapshot,
  ) {
    final docs =
        snapshot.docs.map(HistoryRecordQueryDocumentSnapshot._).toList();
  ...
  static FirestoreDocumentChange<HistoryRecordDocumentSnapshot>
      _decodeDocumentChange<T>(
    DocumentChange<T> docChange,
    HistoryRecordDocumentSnapshot Function(DocumentSnapshot<T> doc) decodeDoc,
  ) {
...
class HistoryRecordQueryDocumentSnapshot
    extends FirestoreQueryDocumentSnapshot<HistoryRecord>
    implements HistoryRecordDocumentSnapshot {
  HistoryRecordQueryDocumentSnapshot._(this.snapshot) : data = snapshot.data();
