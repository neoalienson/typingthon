...
void main() {
  ...
  test('Normalise color inversed', () {
    var k = Keyboard(title: "", map: const {}, max: 100,
      colorMultipler: Colors.white);
  ...
  test('Normalise based color inversed', () {
    var k = Keyboard(title: "", map: const {}, max: 100,
      colorMultipler: Colors.white, colorBase: Colors.grey,);
    expect(k.colorNormalise(0, true), Colors.white);
    expect(k.colorNormalise(100, true), Colors.white);    
  });
  ...
  test('Normalise based color inversed', () {
    var k = Keyboard(title: "", map: const {}, max: 100,
      colorMultipler: yellow, colorBase: Colors.grey,);
    expect(k.colorNormalise(0, true), Colors.white);
